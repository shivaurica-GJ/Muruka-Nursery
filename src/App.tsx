...
function App() {
  ...
  useEffect(() => {
    const handleScroll = () => {
      const sections = ['home', 'fruit-trees', 'evergreen', 'shrubs', 'flowering-trees'];
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-emerald-50">
        ...
        <main>
          ...
          <ProductSection
            ...
            icon={<Apple className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 text-red-500" />}
          ...
          <ProductSection
            ...
            icon={<Mountain className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 text-green-600" />}
          ...
          <ProductSection
            ...
            icon={<Leaf className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 text-green-500" />}
          ...
          <ProductSection
            ...
            icon={<Flower className="w-8 sm:w-10 lg:w-12 h-8 sm:h-10 lg:h-12 text-pink-500" />}
